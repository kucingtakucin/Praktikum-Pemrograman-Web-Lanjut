                        ...
                        <div class="px-4 py-5 bg-gray-800 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    form_input(['type' => 'text', 'name' => 'nim', 'id' => 'nim' , 'autocomplete' => 'off', 'value' => old('nim'), 'class' => "px-2 py-1 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"]) ?>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <?= form_input(['type' => 'text', 'name' => 'nama_lengkap', 'id' => 'nama_lengkap' , 'autocomplete' => 'off', 'value' => old('nama_lengkap'), 'class' => 'px-2 py-1 mt-1 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) ?>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <?= form_password(['name' => 'password', 'id' => 'password' , 'autocomplete' => 'off', 'value' => old('password'), 'class' => 'px-2 py-1 mt-1 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) ?>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <?= form_input(['type' => 'email', 'name' => 'email', 'id' => 'email' , 'autocomplete' => 'off', 'value' => old('email'), 'class' => 'px-2 py-1 mt-1 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) ?>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <?= form_input(['type' => 'date', 'name' => 'tanggal_lahir', 'id' => 'tanggal_lahir', 'autocomplete' => 'off', 'value' => old('tanggal_lahir'), 'class' => 'px-2 py-1 mt-1 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) ?>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    ?>
                                    <?= form_dropdown(['name' => 'prodi', 'id' => 'prodi', 'class' => 'px-2 py-1 mt-1 mt-1 form-select focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md'], $prodi) ?>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <?= form_input(['type' => 'text', 'name' => 'status', 'id' => 'status' , 'value' => 'Aktif', 'autocomplete' => 'off', 'class' => 'px-2 py-1 mt-1 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) ?>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <?= form_textarea(['name' => 'keterangan', 'id' => 'keterangan', 'autocomplete' => 'off', 'value' => old('keterangan'), 'class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md'])?>
